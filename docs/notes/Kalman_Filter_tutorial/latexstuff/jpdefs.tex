...
\newcounter{asection}
\renewcommand{\theasection}{\Alph{asection}}

\newcommand{\asection}[1]{
  % \addtocounter{asection}{1}
  \refstepcounter{asection}
        \setcounter{subsection}{0}
        \section*{Appendix \Alph{asection}: #1}
        \addcontentsline{toc}{asection}{Appendix \Alph{asection}: #1}}

\newcommand{\asubsection}[1]{
        \addtocounter{subsection}{1}
        \subsection*{\Alph{asection}.\arabic{subsection} #1}
\addcontentsline{toc}{subsection}{\Alph{asection}.\arabic{subsection} #1}}

\newcommand{\asubsubsection}[1]{
        \addtocounter{subsubsection}{1}
        \subsection*{\Alph{asection}.\arabic{subsection}. .\arabic{subsubsection} #1}
\addcontentsline{toc}{subsection}{\Alph{asection}.\arabic{subsection}.\arabic{subsubsection} #1}}
